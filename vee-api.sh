...
SENDM=0
API_URL="https://veeam.interagisco.it/api/jobs/"
API_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Im1hdHRlby5jb3N0YW50aW5pIiwiZXhwIjoxNzIwMDAxNjYyfQ.1TPJ260iUz92OOMhYFtP2ZEMdvFCl1kAb1977A0MBpU"  # Sostituisci con il tuo API key
...
curl_cmd="curl -s -o /dev/null -w \"%{http_code}\" -X POST \"$API_URL\" -H \"Accept: application/json\" -H \"Content-Type: application/json\" -H \"Authorization: Bearer $API_KEY\" -d '$payload'"
